    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishOrder", x => x.DishOrderId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishOrderIngredients", x => new { x.DishOrderId, x.IngredientId });
                    table.ForeignKey(
                        name: "FK_DishOrderIngredients_DishOrder_DishOrderId",
                        column: x => x.DishOrderId,
                        principalTable: "DishOrder",
                        principalColumn: "DishOrderId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DishOrderIngredients_Ingredients_IngredientId",
                        column: x => x.IngredientId,
                        principalTable: "Ingredients",
                        principalColumn: "IngredientId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DishOrderIngredients_IngredientId",
                table: "DishOrderIngredients",
                column: "IngredientId");
